...
def main(settings):
	...
	print("\n--------------------Preprocessing Fewshot TACRED 5-way 5-shot--------------------\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', type=str, default="fewshot_tacred/5_way_5_shot/5_way_5_shots_10K_episodes_3q_seed_160290.jsonl")
